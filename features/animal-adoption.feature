Feature: Any user should be able to adopt an animal
    ...
    Scenario: 04 - A user that have not enter the name should not be able to adopt an animal
        Given I navigate to animal adoption home page
